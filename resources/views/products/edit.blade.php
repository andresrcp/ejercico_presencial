...
<div class="container">
    <div class="row">
        <div class="col-4">
            ...
            <form action="{{route('products.update', $product->id)}}" class="mt-2" method="post">
                @csrf
                @method('PUT')
                ...
                <input type="text" name="image" id="image" class="form-control" placeholder="www.google.com."
                       aria-describedby="imagelHelp" value="{{$product->image}}">
                ...
                <div class="input-group mb-3">
                    ...
                    <select class="form-select" id="companies_id" name="companies_id">
                        <option selected value="{{$product->company->id}}">{{$product->company->name}}</option>
